...
// Useful variables with talk values:
// controlPath ->= /talk/control
// contextRoot -> C:\dev\floss\ofbiz\ofbiz-framework\plugins\talk\webapp\talk\
// serverRoot -> https://localhost:8443
// context.application.context.context.path -> /talk

// Path component of URL leading to the servlet mount point, e.g. '/talk'.
String contextUrlPath = context.application.context.context.path
// Filesystem path to the webapp root, e.g. '$ofbiz-framework/plugins/talk/webapp/talk/'.
